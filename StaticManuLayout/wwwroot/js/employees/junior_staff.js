...
function loadInitialData() {
    ...
    $.ajax({
        url: '/api/Grades/GetGradesByEmployeeType?employeeTypeId=2',
        type: 'Get',
        async: false,
        dataType: 'json',
        success: function (responseObject) {
    ...
    $.ajax({
        url: '/api/Designations/GetDesignationsByEmployeeType?employeeTypeId=2',
        type: 'Get',
        async: false,
        dataType: 'json',
        success: function (responseObject) {
...
function getEmployeeList() {
    ...
    _dataTable = $('#employee_list_table').DataTable({
        ajax: {
            url: '/api/Employees/GetEmployees?employeeTypeId=2',
            dataSrc: 'data'
        },
        columns: [
            {
